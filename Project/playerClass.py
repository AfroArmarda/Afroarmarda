...
class player:
    def __init__(self, load_x, load_y, move_x, move_y, flip, easterEgg):
    ...
    def playerMove(self):
        ...
        if self.easterEgg == 4:
            character_R = pygame.image.load("Julie.jpg")
            character_L = pygame.transform.flip(character_R,True, False)

            character_R_W = pygame.image.load("Julie.jpg")
            character_L_W = pygame.transform.flip(character_R_W, True, False)
