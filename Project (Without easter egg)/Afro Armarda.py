...
pygame.display.set_caption("Afro Armarda")
...
def game_intro():
    ...
    while intro:
        ...
        for event in pygame.event.get():
            ...
            message("Welcome to Afro Armarda", red, 100, 17, 50)
...
#player list
clist.append(playerClass.player(displayWidth/2, displayHeight/2, 0, 0, 0))
